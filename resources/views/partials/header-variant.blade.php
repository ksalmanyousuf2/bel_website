<header class="navbar-transparent navbar-black-links text-white py-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <ul class="navbar-nav mx-auto align-items-center">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('about-us') }}#about">Who are we</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="solutionsDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('home') }}#solutions">Industrial & Commercial</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="ms-3">
                        <a href="#contact" class="btn btn-outline-primary flex-shrink-0 btn-outline-primary-cta text-white d-inline-flex align-items-center" style="border-radius: 28px; border-color:white !important; gap: 8px;">
                            Get connected
